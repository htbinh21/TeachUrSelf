...
public class Test2 {
 ...
 public static void main(String[] args) throws IOException {
  ...
  System.setProperty("webdriver.gecko.driver", "E:\\Soft\\geckodriver-v0.11.1-win64\\geckodriver.exe");
  WebDriver driver = new FirefoxDriver();
  driver.manage().window().maximize();		

  driver.get("http://web.churoi.go.jp/h_index.html");
 ...
 public static boolean getResponseCode(String chkurl) {
  ...
  // HttpResponse urlresp = new DefaultHttpClient().execute(new HttpGet(chkurl));
   ...
   HttpResponse urlresp = client.execute(request);
